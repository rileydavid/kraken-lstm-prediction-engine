...
use service::import::import_dto::FileNameDto;
...
pub async fn get_files() -> Result<Json<Vec<FileNameDto>>, ResponseError> {
    prepare_response(import_service::get_files().await)
}
